...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { description: @adventure.description, name: @adventure.name, picture: @adventure.picture, string: @adventure.string, visit: @adventure.visit }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { description: @adventure.description, name: @adventure.name, picture: @adventure.picture, string: @adventure.string, visit: @adventure.visit }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
